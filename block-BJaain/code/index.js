...
myObject.someMethod(); // function () undefined
...
let person_name = new Person('John', 'Reed');
person_name.displayName(); // Name : John Reed
let person2_name = new Person('Paul', 'Adams');
person2_name.displayName(); // Name : Paul Adams
...
// 14 {data: Array(3), dataDouble: Array(3), double: ƒ, doubleArrow: ƒ}
// 16 {data: Array(3), dataDouble: Array(3), double: ƒ, doubleArrow: ƒ}
// 16 {data: Array(3), dataDouble: Array(3), double: ƒ, doubleArrow: ƒ}
// 16 {data: Array(3), dataDouble: Array(3), double: ƒ, doubleArrow: ƒ}
//  [2, 4, 6]
...
console.log(getSecondData()); // 2 and while callling the function bind methods treats obj1 as a parameter 
